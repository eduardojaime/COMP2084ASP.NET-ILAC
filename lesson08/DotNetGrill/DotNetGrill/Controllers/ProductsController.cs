...
namespace DotNetGrill.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,Name,Description,Price,Photo,Rating,CategoryId")] Product product, IFormFile? photo, string? CurrentPhoto)
        {
